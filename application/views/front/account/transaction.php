...
<div><h2><strong>My Transactions</strong></h2></div>
...
<table class="table table-bordered table-responsive">
	...
	foreach($result->result() as $result){?>
		<tr>
			...
			<td><?php echo date("d/m/Y", strtotime($result->dot));?></td>
			<td>

			<?php if($result->status == 1){ echo 'Success'; }
				elseif($result->status == 2){ echo 'Deny'; }
				elseif($result->status == 3){ echo 'Accepted'; }
				elseif($result->status == 4){ echo 'Pending'; }
				else{ 'Lost'; }
			?>
