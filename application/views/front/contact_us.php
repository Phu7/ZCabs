...
<p><strong>*</strong> fields are mandatory</p>
		...
		<div class="form-group">
			<input  type="text" name="mobile" id="contact" class="form-control" placeholder="Contact Number*" value="" required="required">
		</div>
		<div class="form-group">
			<input  type="text" name="dep_date" autocomplete="off" placeholder="Choose Your Travel Date *" class="form-control" id="det1" required="required">
		</div>
