 ...
 <div class="alert alert-danger"><button type="button" class="close" data-dismiss="alert" aria-label="close">x</button>
		...
		<?php } echo $msg_data; ?> </div><?php } $this->admin->removeInfo();?>
			...
			<div class="col-md-12 col-sm-12 col-xs-12">
			 <h5><i class="fa fa-list"></i> Outstation Trip to be Added</h5>
                <div class="x_panel">
                  ...
                  <div class="x_content">
				    <table id="example" class="table table-bordered">
                      <thead>
                        <tr>
                          <th>#</th>
                          <th>Trip Cateogory</th>
                          <th>Going From</th>
                          <th>Going To</th>
                          <th>Travel Date </th>
                          <th>Offer Fare</th>
                          <th>Vehicle Name</th>
                          <th>Avaiblabe Seats</th>
                          <th>Created</th>
                        </tr>
                      </thead>
			...
			$('#example').dataTable({
				...
				"order":[],
				"ajax":{
						url:"<?php echo base_url();?>admin/outstationschedule/get_list",
						type:"POST"
					},
					"columnDefs":[
					{
