<?php $this->load->view('admin/home/header');?>
            <div class="page-title">
			  ...
			  <a class="btn btn-info btn-sm pull-right" data-toggle="tooltip" title="Add" href="<?php echo base_url()?>admin/location/city_add"><i class="fa fa-plus"></i></a>
			...
			<div class="col-md-12 col-sm-12 col-xs-12">
			 <h5><i class="fa fa-list"></i> Cities List</h5>
                <div class="x_panel">
				 ...
				 <select class="form-control" name="state_id" id="state_id" onchange="window.open('<?php echo base_url()?>admin/location/city?state='+this.value+'','_self');">
				 ...
				 <?php }?>
                  ...
                  <div class="x_content">
				  <?php echo form_open('admin/location/delete_city', array("id"=>"delete_form"));?>
