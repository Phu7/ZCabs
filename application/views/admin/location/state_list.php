<?php $this->load->view('admin/home/header');?>
            <div class="page-title">
			  ...
			  <a class="btn btn-info btn-sm pull-right" data-toggle="tooltip" title="Add" href="<?php echo base_url()?>admin/location/state_add"><i class="fa fa-plus"></i></a>
 ...
 <div class="alert alert-danger"><button type="button" class="close" data-dismiss="alert" aria-label="close">x</button>
		...
		<?php } echo $msg_data; ?> </div><?php } $this->admin->removeInfo();?>
			...
			<div class="col-md-12 col-sm-12 col-xs-12">
			 <h5><i class="fa fa-list"></i> States List</h5>
                <div class="x_panel">
                 
                  <div class="x_content">
				  <?php echo form_open('admin/location/delete_state', array("id"=>"delete_form"));?>
				    <table id="datatable" class="table table-bordered">
					  ...
					  <td><a class="btn btn-info btn-sm" href="<?php echo base_url()?>admin/location/state_add?id=<?php echo $result->id;?>"><i class="fa fa-pencil"></i></button></td>
					  </tr>
					  <?php }?>
					  </tbody>
                    </table>
