...
<div class="main-content">
  <section class="inner-header  divider parallax layer-overlay overlay-gray-8" >
        ...
        <div class="section-content">
          <div class="row">
            <div class="col-md-12 text-left">
               <h2 class="text-uppercase title mt-0 text-left"><?php echo ($result['breadcrum'] == "") ? $result['name'].'<span class="text-black font-weight-300">Let\'s Talk Academy</span>':$result['breadcrum']; ?> </h2>
              <ol class="breadcrumb text-left text-black mt-10">
                <li><a href="#">Home</a></li>

                <li class="active text-theme-colored"><?php echo ($result['breadcrum'] == "") ? $result['name']:$result['breadcrum'];?></li>
              </ol>
            </div>
          </div>
        </div>
...
<div class="about-page pt-30 pb-0">
    <div class="container">
    <div class="row">
    <div class="col-md-8">
   ...
   <div class="col-md-4 col-sm-12 mt-sm-60 ">
   <div class="features">
         <div class="head-bg">
...
<!--start-->
      <div class="registration">
          ...
          <div class="border-1px p-25">
              ...
              <div class="ajax-appointment" id="ajax-appointment1"></div>
			<?php echo form_open("account/add_online", array("id"=>"appointment_form1", "name"=>"appointment_form", "class"=>"mt-10 mb-0")); ?>  <div class="row">
                  <div class="col-sm-12">
                ...
                <div class="form-group mb-0 mt-20">
                  <input type="submit" class="btn btn-dark btn-theme-colored" data-loading-text="Please wait..." id="submitBtn23" value="Submit">
                </div>
              <?php echo form_close(); ?>
            </div>
            </div>
<script>
	...
	$('#appointment_form1').on('submit', (function(e) {
		e.preventDefault();
		 $.ajax({
            url: '<?php echo base_url();?>account/add_online',
            type: "POST",
            contentType: false,
            ...
            processData:false,
			beforeSend: function() {
  				$('#submitBtn23').prop('value','Please Wait...');
				$("#submitBtn23").prop("disabled", true);
  			},
  			complete: function() {
  				$('#submitBtn23').prop('value','Submit');
				$("#submitBtn23").prop("disabled", false);
  			},
            success:
            function(data){
				$('#appointment_form1')[0].reset();
				$('#ajax-appointment1').html('<div class="alert alert-info"><button type="button" class="close" data-dismiss="alert" aria-label="close">x</button>Thank you to apply Online. We will catch you soon.</div>');
            },
            error: function(){}
          });
}));
