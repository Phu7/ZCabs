...
<a class="btn btn-info btn-sm pull-right" data-toggle="tooltip" title="Add" href="<?php echo base_url()?>admin/rescat/add_form"><i class="fa fa-plus"></i></a>
...
<h5><i class="fa fa-list"></i> Result Category List</h5>
    <div class="x_panel">

      <div class="x_content">
<?php echo form_open('admin/rescat/delete',array('id'=>'delete_form'));?>
...
<td><a href="<?php echo base_url().'admin/rescat/add_form?id='.$result->id;?>" class="btn btn-sm btn-primary"><i class="fa fa-pencil"></i></a></td>
</tr>
<?php }?>
</tbody>
        </table>
